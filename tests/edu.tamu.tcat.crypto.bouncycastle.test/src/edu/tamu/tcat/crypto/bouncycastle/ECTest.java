...
public class ECTest extends AsymmetricKeyTest
{
   ...
   public void testECPublicReadWrite() throws Exception
   {
      ...
      PublicKey publicKey = provider.getX509KeyDecoder().decodePublicKey("ec", publicKeyBytes);
   ...
   {
      PrivateKey privateKey = provider.getAsn1SeqKey().decodePrivateKey("EC", Hex.decode(ECPrivateKey));
   ...
   {
      KeyPair keyPair = provider.getAsymmetricKeyBuilder().generateECKeyPair(Curve.Secp521r1);
